                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="email" required class="form-control" id="email" name='email' value={{ $supplier->email }}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" required class="form-control" id="phone" name='phone' value={{ $supplier->phone }}>
                            </div>
                        </div>
